<nav>
    <article>
        ...
        <button class="nav-link">
            <a href="../user/mns.php"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    viewBox="0 0 24 24">
                    <path
        ...
        <button class="nav-link">
            <a href="../user/messages.php"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    viewBox="0 0 24 24">
                    <path
