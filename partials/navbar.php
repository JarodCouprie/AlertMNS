<nav>
    <article>
        <button class="nav-link">
            <a class="link" href="../user/main.php">
        ...
        <button class="nav-link">
            <a class="link" href="../user/mns.php"><svg class="nav-svg" xmlns="http://www.w3.org/2000/svg" width="24"
        ...
        <button class="nav-link">
            <a class="link" href="../user/messages.php"><svg class="nav-svg" xmlns="http://www.w3.org/2000/svg"
        ...
        <button class="nav-link">
            <a class="link" href="../user/calendar.php">
                <svg class="nav-svg" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <path
        ...
        <button class="nav-link">
            <a class="link" href="../user/mails.php">
                <svg class="nav-svg" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <path
        ...
        <a class="link" href="../admin/dashboard.php">
          <svg class="nav-svg" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    <article>
        ...
        <button class="nav-link">
            <a class="link" href="../tools/deconnection.php">
                <svg class="nav-svg" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <path
